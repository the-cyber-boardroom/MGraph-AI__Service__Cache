...
# from mgraph_ai_service_cache.service.cache.store.Service__Cache__Store__Child                 import Service__Cache__Store__Child
# from tests.unit.Service__Cache__Test_Objs                                                     import setup__service__cache__test_objs
#
# from osbot_utils.utils.Dev import pprint
#
# class test_Service__Cache__Store__Child(TestCase):
#
#     @classmethod
#     def setUpClass(cls):
#         pytest.skip("needs refactoring of Service__Cache__Store__Child (namely how data files are stored)")
...
#         cls.child_service    = Service__Cache__Store__Child(cache_service = cls.cache_service)
#
...
#         # todo: see if we need this, since we are running in memory
#         cls.created_children = []                                                              # Track created children for cleanup
#
#
#     def test__init__(self):                                                                     # Test auto-initialization
#         with Service__Cache__Store__Child() as _:
#             assert type(_)               is Service__Cache__Store__Child
...
#             assert result.size == len(self.test_binary)
#
#             self.created_children.append(Safe_Str__Id("child-bin-001"))
#
