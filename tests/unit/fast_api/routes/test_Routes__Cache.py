...
#
#         # Test data
#         cls.test_namespace = Safe_Str__Id("test-api")
...
#         with self.routes as _:
#             #self.request.state.body = self.test_string.encode()
#             _.store__string__strategy__namespace(data=self.test_string, namespace=Safe_Str__Id("ns1"))                       # Create some namespaces
#             _.store__string__strategy__namespace(data=self.test_string, namespace=Safe_Str__Id("ns2"))
#
#             result = _.namespaces()
#
