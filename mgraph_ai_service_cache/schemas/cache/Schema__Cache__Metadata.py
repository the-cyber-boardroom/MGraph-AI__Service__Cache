...
class Schema__Cache__Metadata(Type_Safe):                                             # Metadata about cached entry
    cache_id         : Random_Guid                                                    # Unique ID of this cache entry
    ...
    namespace        : Safe_Str__Id                                                        # Namespace for isolation
    strategy         : Enum__Cache__Store__Strategy                                   # Storage strategy used
    stored_at        : Safe_Str__Text                                                 # When stored (timestamp)
