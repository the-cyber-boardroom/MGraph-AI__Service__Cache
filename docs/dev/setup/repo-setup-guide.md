# MGraph-AI Service Cache - Setup Guide

This guide walks through the complete setup process from initial repository creation to v1.0.0 release.

## 📋 Prerequisites

- GitHub repository created: `https://github.com/the-cyber-boardroom/MGraph-AI__Service__Cache`
...
git clone https://github.com/the-cyber-boardroom/MGraph-AI__Service__Cache.git
cd MGraph-AI__Service__Cache

# 2. Create initial commit (empty repo)
git init
echo "# MGraph-AI Service Cache" > temp.md
git add temp.md
git commit -m "Initial repository creation"
git branch -M main
git remote add origin https://github.com/the-cyber-boardroom/MGraph-AI__Service__Cache.git
...
git add .
git commit -m "First commit for MGraph-AI Service Cache - v1.0.0 scaffold with FastAPI setup, tests, and CI/CD pipeline"
...
3. **Verify AWS Lambda**:
   ...
   - Look for `mgraph_ai_service_cache-dev`
...
3. **Test the domain**:
   ...
   # Should return: {"status":"healthy","service":"mgraph_ai_service_cache"}
   ```
...
3. **Verify QA deployment**:
   ...
   - Lambda function `mgraph_ai_service_cache-qa` should be created
...
2. **Verify production deployment**:
   - Lambda function `mgraph_ai_service_cache-prod` should be created
...
echo "v1.0.0" > mgraph_ai_service_cache/version
...
# Commit changes
git add mgraph_ai_service_cache/version README.md pyproject.toml
...
echo "   1. Go to https://github.com/the-cyber-boardroom/MGraph-AI__Service__Cache/releases"
...
This completes the setup! Your MGraph-AI Service Cache is now fully operational across all environments.