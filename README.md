...
[![Current Release](https://img.shields.io/badge/release-v0.5.18-blue)](https://github.com/the-cyber-boardroom/MGraph-AI__Service__Cache/releases)
...
To create a new service from this template, see [Creating Services from MGraph-AI__Service__Cache](docs/dev/non-functional-requirements/version-1_0_0/README.md).
...
# or
uvicorn mgraph_ai_service_cache.fast_api.lambda_handler:app --reload --host 0.0.0.0 --port 10011
```
...
# Run with coverage
pytest --cov=mgraph_ai_service_cache
...
- 🐛 Issues: [GitHub Issues](https://github.com/the-cyber-boardroom/MGraph-AI__Service__Cache/issues)
- 💬 Discussions: [GitHub Discussions](https://github.com/the-cyber-boardroom/MGraph-AI__Service__Cache/discussions)
